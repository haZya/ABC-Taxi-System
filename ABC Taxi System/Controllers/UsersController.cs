...
using ABC_Taxi_System.Models;
using PagedList;
using System.Net.Mail;
using System.Web.Security;
using System.Web;
using ABC_Taxi_System.Helpers;

namespace ABC_Taxi_System.Controllers
{
    /// <summary>
    ...
    public class UsersController : ApplicationBaseController
    {
        ...
        public void SendEmail(string email, string activationCode, string fName, string username, string password, string emailFor = "VerifyAccount")
        {
            ...
            var fromEmail = new MailAddress("noreply.abc.taxi@gmail.com", "ABC Taxi Company");
            ...
            if (emailFor == "VerifyAccount")
            {
                ...
                body = $"<br/>Dear { fName }," +
                    "<br/><br/>We are excited to inform you that your ABC Taxi account has been created successfully. " +
                    ...
                    $"<br/><br/>Copyright © { DateTime.Now.Year } - ABC Taxi Company. All rights reserved.";
            }
            if (emailFor == "VerifyUpdate")
            {
                subject = "Your account details have been updated successfully!";
                body = $"<br/>Dear { fName }," +
                    "<br/><br/>Your ABC Taxi account details have been updated successfully. " +
                    "Please click the link below to verify your account," +
                    $"<br/><a href = '{ link }'> Click here to verify your account</a>" +
                    $"<br/><br/><font size='{ 4 }'>Login details:</font>" +
                    $"<br/><b>User Name:</b> { username }" +
                    $"<br/><b>Password:</b> { password }" +
                    "<br/><br/>If you did not update your account details recently, your ABC Taxi account might be at risk, please contact customer support." +
                    $"<br/><br/>Copyright © { DateTime.Now.Year } - ABC Taxi Company. All rights reserved.";
            }
            else if (emailFor == "ResetPassword")
            {
                ...
                body = $"<br/>Dear { fName }," +
                    "<br/><br/>We got a request to reset your ABC Taxi account password. " +
            ...
            else if (emailFor == "ResetPasswordSuccess")
            {
                ...
                body = $"<br/>Dear { fName }," +
                    "<br/><br/>We have successfully updated your ABC Taxi account password. " +
                    $"<br/><a href = '{ loginLink }'> Click here to Login</a>" +
                    $"<br/><br/><font size='{ 4 }'>Login details:</font>" +
                    $"<br/><b>User Name:</b> { username }" +
                    $"<br/><b>New Password:</b> { password }" +
                    "<br/><br/>If you did not reset your password recently, your ABC Taxi account might be at risk, please contact customer support." +
                    $"<br/><br/>Copyright © { DateTime.Now.Year } - ABC Taxi Company. All rights reserved.";
            }
